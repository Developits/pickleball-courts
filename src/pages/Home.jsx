...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        {/* Background Gradient */}
        <div className="absolute inset-0 bg-linear-to-br from-green-50 via-white to-blue-50 -z-10"></div>
        ...
        <div
          className="absolute top-0 right-0 w-64 h-64 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse"
      ...
      <section
        ref={featuresRef}
        className="py-16 sm:py-20 lg:py-28 px-4 sm:px-6 bg-linear-to-b from-gray-50 to-white opacity-0 translate-y-8 transition-all duration-700 ease-out"
      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
            ...
            <div className="card group hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 cursor-pointer">
              ...
              <p className="text-gray-600 text-base sm:text-lg lg:text-xl leading-relaxed">
                Play 1 match, wait 1 match — no more court-hopping or unfair
                advantages
              </p>
            </div>
            ...
            <div className="card group hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 cursor-pointer">
              ...
              <p className="text-gray-600 text-base sm:text-lg lg:text-xl leading-relaxed">
                Automatic court allocation ensures everyone gets to play with
                balanced teams
              </p>
            </div>
      ...
      {/* Rules Section */}
      <section className="py-16 sm:py-20 lg:py-28 px-4 sm:px-6 bg-linear-to-b from-white to-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="card bg-white">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                <li>
                  You must check in at the courts using the dynamic QR code
                </li>
            ...
            <div className="card bg-white">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-600">
                ...
                <li>
                  Players arriving after 8:30 PM get priority over those who
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 bg-linear-to-r from-green-500 to-green-600 relative overflow-hidden">
        {/* Decorative circles */}
