  ...
  try {
    ...
    if (!match_id || team1_score === undefined || team2_score === undefined) {
      return createErrorResponse(
        "match_id, team1_score, and team2_score are required",
        400,
      );
    }
    ...
    if (score1 > score2) {
      ...
      `,
        ...
        .bind(match.team1_player1_id, match.team1_player2_id)
        .all();
      ...
      `,
        ...
        .bind(match.team2_player1_id, match.team2_player2_id)
        .all();
      winner_name = winnerUsers.results.map((u) => u.name).join(" & ");
    } else {
    ...
    `,
      ...
      .bind(winner_team, formattedScore, match_id)
      .run();
